    ...
    const data = [
        {
            ...
            name: "Dr. Mary Wanjiku Mwangi",
            specialties: "Orthopedic Surgeon",
        },
        {
            img: "src/assets/img/img2.jpg",
            name: "Dr. Marrianna Waswa",
    ...
    <div className="min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16">
      <div className="flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
        <div>
          ...
          Our Doctors are compassionate, knowledgeable, and dedicated professionals who
            diagnose, treat, and care for patients with skill and empathy.
          </p>
        </div>
      ...
      <div className='mt-5'>
        <Slider ref={slider}  {...settings}>
                {data.map((e , index) => (
                    ...
                    >
                      <div>
                        <img src="e.img" alt="img" className='h-5/' />
                        </div>
